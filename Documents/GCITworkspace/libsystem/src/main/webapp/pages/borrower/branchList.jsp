				...
				<form class="form-signin" action="bookCopyList">
					...
					%>
						<tr>
							...
							<td><a href="/libsystem/pages/borrower/bookCopyList?branchId=<%=branch.getBranchId()%>&cardNo=<%=cardNo%>"><button type="button" class="btn btn-primary">Confirm</button></a></td>
						</tr>
					<%
						}
					%>
